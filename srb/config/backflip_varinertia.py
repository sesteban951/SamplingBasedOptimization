...
config = AerialConfig(
    ...
    costs=CostWeights(
        ...
        Q_flip_mid=50.0,  # midpoint orientation cost to enforce backflip direction
        Q_stance_align = 5e1,  # encourage the body to pitch forward as the CoM moves behind the feet
    ),
