...
# fix timings
dt = 0.02        # time step
T_stance = 1.0   # stance duration
T_flight = 0.5   # flight duration
T_land =   0.8   # landing duration
...
x_goal = np.array([px_goal, 0, pz_nom, # p_com (forward, same height)
